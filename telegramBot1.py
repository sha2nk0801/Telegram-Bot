...
# OpenAI secret Key
API_KEY = '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'
# Models: text-davinci-003,text-curie-001,text-babbage-001,text-ada-001
MODEL = 'text-davinci-003'
# Telegram secret access bot token
BOT_TOKEN = '5695228329:AAEB4JJSK-6LcaziR1zFMx7OAguQ4uXOQ7Q'
# Defining the bot's personality using adjectives
BOT_PERSONALITY = 'Assume yourself to be a Data Scientist and Data Analyst' 
